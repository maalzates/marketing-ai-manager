...
/** Waits on the Campaigns module: pausing means pausing the campaign in Meta, not only locally. */
readonly class PauseExperimentExecutor implements ProposalExecutorInterface
{
